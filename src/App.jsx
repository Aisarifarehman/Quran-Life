...
import { 
  ...
  Globe, Sparkles, ChevronRight, Menu, X 
} from 'lucide-react';
...
export default function App() {
  ...
  // Fetch Ayahs & Translation when Surah, Reciter, or Language changes
  useEffect(() => {
    setLoading(true);
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {loading ? (
            <div className="flex items-center justify-center h-64 text-slate-400 gap-2">
              <Sparkles className="animate-spin text-emerald-500" /> Loading Ayahs & Translations...
            </div>
          ) : (
            ayahs.map((ayah) => {
