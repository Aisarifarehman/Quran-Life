...
// Custom inline SVGs with explicit fixed sizes to prevent blowout
const ArrowLeftIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-100">
        ...
        <div className="max-w-4xl mx-auto px-4 py-3">
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-3">
              <button 
                onClick={onBack}
                className="p-1.5 rounded-lg bg-emerald-800/80 hover:bg-emerald-800 transition-colors flex items-center justify-center"
                title="Go Back"
              >
                <ArrowLeftIcon />
              </button>
